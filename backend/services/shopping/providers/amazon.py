...
class AmazonProvider(ShoppingProvider):
    ...
    def is_configured(self) -> bool:
        return bool(os.getenv("AMAZON_API_KEY", "").strip()) or bool(os.getenv("TAVILY_API_KEY", "").strip()) or bool(os.getenv("GEMINI_API_KEY", "").strip())
    ...
    def search_products(self, query: str, filters: dict = None) -> dict:
        ...
        search_query = f"site:amazon.in {query}"
        ...
        try:
            ...
            for item in raw_results:
                ...
                # Extract standard ASIN or product code from Amazon link
                prod_id_match = re.search(r'/dp/([A-Z0-9]{10})', item_url)
