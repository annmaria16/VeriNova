...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#08120F] border-t border-[#14532D]/40 pt-16 pb-12 overflow-hidden">
      {/* Footer Top Grid */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-[#14532D]/20">
        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          ...
          <div className="flex gap-4 mt-2">
            ...
            <a
              ...
              className="w-10 h-10 rounded-xl bg-[#10211C] border border-[#14532D] flex items-center justify-center text-gray-400 hover:text-white hover:border-[#22C55E] hover:shadow-[0_0_12px_rgba(34,197,94,0.3)] transition-all duration-300"
            >
      ...
      {/* Footer Bottom Row */}
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500 font-medium">
        <p>© {new Date().getFullYear()} VeriNova Inc. All rights reserved.</p>
        <button
          onClick={handleScrollToTop}
          className="flex items-center gap-1.5 px-3 py-1.5 border border-[#14532D] rounded-lg text-gray-400 hover:text-white hover:border-[#22C55E] transition-all duration-300"
        >
