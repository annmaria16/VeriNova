    ...
    <footer className="relative bg-dash-sidebar border-t border-dash-border pt-16 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-dash-border/60">
        ...
        <div className="lg:col-span-2 flex flex-col gap-5 text-left">
          ...
          >
            <div className="bg-gradient-to-br from-[#8B5CF6] via-[#EC4899] to-[#22D3EE] p-2 rounded-xl shadow-lg shadow-violet-500/10 group-hover:shadow-violet-500/30 transition-all duration-300">
          ...
          <div className="flex gap-4 mt-2">
            ...
            <a
              ...
              className="w-10 h-10 rounded-xl bg-dash-card border border-dash-border flex items-center justify-center text-dash-secondary hover:text-dash-primary hover:border-dash-primary hover:shadow-[0_4px_12px_rgba(139,92,246,0.15)] transition-all duration-300"
            >
